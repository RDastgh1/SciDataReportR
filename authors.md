...
- **Raha Dastgheyb**. Author, maintainer.
  [](https://orcid.org/0000-0002-4992-711X)

## Citation

Source:
[`DESCRIPTION`](https://github.com/RDastgh1/SciDataReportR/blob/v20.13.0/DESCRIPTION)

Dastgheyb R (2026). *SciDataReportR: Workflow Infrastructure for
Reproducible Scientific Data Reporting*. R package version 20.13.0,
<https://github.com/RDastgh1/SciDataReportR>.
    ...
    @Manual{,
      ...
      year = {2026},
      note = {R package version 20.13.0},
