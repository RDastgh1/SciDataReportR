...
Source:
[`DESCRIPTION`](https://github.com/RDastgh1/SciDataReportR/blob/v20.9.0/DESCRIPTION)

Dastgheyb R (2026). *SciDataReportR: Workflow Infrastructure for
Reproducible Scientific Data Reporting*. R package version 20.9.0,
