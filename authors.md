...
Source:
[`DESCRIPTION`](https://github.com/RDastgh1/SciDataReportR/blob/v19.0.0/DESCRIPTION)

Dastgheyb R (2026). *SciDataReportR: Workflow Infrastructure for
Reproducible Scientific Data Reporting*. R package version 19.0.0,
