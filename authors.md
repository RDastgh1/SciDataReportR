...
Source:
[`DESCRIPTION`](https://github.com/RDastgh1/SciDataReportR/blob/v21.9.0/DESCRIPTION)

Dastgheyb R (2026). *SciDataReportR: Workflow Infrastructure for
Reproducible Scientific Data Reporting*. R package version 21.9.0,
