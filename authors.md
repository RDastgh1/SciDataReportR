...
Source:
[`DESCRIPTION`](https://github.com/RDastgh1/SciDataReportR/blob/v21.5.0/DESCRIPTION)

Dastgheyb R (2026). *SciDataReportR: Workflow Infrastructure for
Reproducible Scientific Data Reporting*. R package version 21.5.0,
