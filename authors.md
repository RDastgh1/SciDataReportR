...
Source:
[`DESCRIPTION`](https://github.com/RDastgh1/SciDataReportR/blob/v20.20.0/DESCRIPTION)

Dastgheyb R (2026). *SciDataReportR: Workflow Infrastructure for
Reproducible Scientific Data Reporting*. R package version 20.20.0,
<https://github.com/RDastgh1/SciDataReportR>.
    ...
    @Manual{,
      ...
      year = {2026},
      note = {R package version 20.20.0},
