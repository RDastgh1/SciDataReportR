...
- [`AnalyzeFeatureModuleTraits()`](https://rdastgh1.github.io/SciDataReportR/reference/AnalyzeFeatureModuleTraits.md)
...
- [`AssessFeatureMissingness()`](https://rdastgh1.github.io/SciDataReportR/reference/AssessFeatureMissingness.md)
  : Assess missingness in a wide feature matrix
- [`BuildFeatureWGCNA()`](https://rdastgh1.github.io/SciDataReportR/reference/BuildFeatureWGCNA.md)
...
- [`CreateMScoreObject()`](https://rdastgh1.github.io/SciDataReportR/reference/CreateMScoreObject.md)
  [`CalcMScore()`](https://rdastgh1.github.io/SciDataReportR/reference/CreateMScoreObject.md)
...
- [`CreateNormativeTScoreModel()`](https://rdastgh1.github.io/SciDataReportR/reference/CreateNormativeTScoreModel.md)
  [`CreateNormativeTScores()`](https://rdastgh1.github.io/SciDataReportR/reference/CreateNormativeTScoreModel.md)
...
- [`CreateZScoreObject()`](https://rdastgh1.github.io/SciDataReportR/reference/CreateZScoreObject.md)
  [`CalcZScore()`](https://rdastgh1.github.io/SciDataReportR/reference/CreateZScoreObject.md)
...
- [`IQROutliers()`](https://rdastgh1.github.io/SciDataReportR/reference/IQROutliers.md)
  : Detect outliers using the Tukey IQR rule and visualize results
- [`InsertValues()`](https://rdastgh1.github.io/SciDataReportR/reference/InsertValues.md)
...
- [`Plot2GroupStats()`](https://rdastgh1.github.io/SciDataReportR/reference/Plot2GroupStats.md)
  : Plot & Summarize Group Stats via MakeComparisonTable (BH q from p;
  SHAPE by p; COLOR by Category (vector or data frame); stable point
...
- [`PlotFeatureModuleTraitHeatmap()`](https://rdastgh1.github.io/SciDataReportR/reference/PlotFeatureModuleTraitHeatmap.md)
  : Plot feature module-trait associations
- [`PlotFeatureWGCNADendrogram()`](https://rdastgh1.github.io/SciDataReportR/reference/PlotFeatureWGCNADendrogram.md)
  : Plot a feature WGCNA dendrogram
- [`PlotFeatureWGCNASoftThreshold()`](https://rdastgh1.github.io/SciDataReportR/reference/PlotFeatureWGCNASoftThreshold.md)
...
- [`PlotMiningMatrix()`](https://rdastgh1.github.io/SciDataReportR/reference/PlotMiningMatrix.md)
  : PlotMiningMatrix
- [`PlotMissingData()`](https://rdastgh1.github.io/SciDataReportR/reference/PlotMissingData.md)
  : Plot Missing Data
...
- [`PlotPathway_KT()`](https://rdastgh1.github.io/SciDataReportR/reference/PlotPathway_KT.md)
  [`CreatePathwayPlot_KT()`](https://rdastgh1.github.io/SciDataReportR/reference/PlotPathway_KT.md)
...
- [`PlotSplitViolin()`](https://rdastgh1.github.io/SciDataReportR/reference/PlotSplitViolin.md)
  : Split violin with aligned half-boxplots, significance label, sample
  sizes, and label-aware title
...
- [`SummarizeTransitions()`](https://rdastgh1.github.io/SciDataReportR/reference/SummarizeTransitions.md)
  ...
  condition
- [`TransformFeatureMatrix()`](https://rdastgh1.github.io/SciDataReportR/reference/TransformFeatureMatrix.md)
...
- [`createFacetLabels()`](https://rdastgh1.github.io/SciDataReportR/reference/createFacetLabels.md)
  : Create facet labels for ggplot2 based on variable labels in a data
  frame
...
- [`removeString()`](https://rdastgh1.github.io/SciDataReportR/reference/removeString.md)
