...
#' different jobs:
#'
#' * `FormattedTable` - a `gt` table with significance already marked, for
#'   dropping into a report.
#' * `LargeTable` - the same content unformatted, when the raw numbers matter
