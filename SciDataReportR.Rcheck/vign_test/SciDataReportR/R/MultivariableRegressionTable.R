...
# ScidrPValueStars() now lives in R/pvalue-stars.R so every function in the
# package cuts stars at the same thresholds. Its defaults reproduce the
# four-tier scale this file used before.
