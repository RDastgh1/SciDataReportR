...
#'
#' @section Checking the match:
#' A merge like this always produces a match, however far away it had to reach,
#' so the time gaps are what decide whether a match is usable. The sign gives
#' the direction: positive means the second record came after the first.
#'
