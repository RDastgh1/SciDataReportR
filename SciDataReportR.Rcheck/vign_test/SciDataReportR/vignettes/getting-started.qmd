...
The examples use the current workflow-oriented function names. Older names such as [`CreatePCATable()`](../reference/CreatePCAObject.html), [`CreateZScorePlot()`](../reference/PlotZScore.html), and [`Make_DataDictionary()`](../reference/MakeDataDictionary.html) remain available as compatibility aliases.
