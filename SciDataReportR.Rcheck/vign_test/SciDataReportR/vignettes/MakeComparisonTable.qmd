...
two-group design only, \(d \approx 2f\). When effect sizes are requested, the
table caption lists the scales that are present and provides conventional
magnitude guides. These guides are heuristics rather than thresholds for
clinical importance.
