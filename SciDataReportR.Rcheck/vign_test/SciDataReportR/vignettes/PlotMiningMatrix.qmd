...
For exploratory mining it is often useful to evaluate a clinically meaningful subset of variables. Full-dataset matrices are better explored interactively because labels become unreadable in a static report.
...
The resulting visualization summarizes associations among the selected clinical and biomarker variables.
