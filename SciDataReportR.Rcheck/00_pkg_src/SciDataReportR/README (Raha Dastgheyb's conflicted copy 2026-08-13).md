...
| Clustering and cohort projection | `CreateClusterModel_SOM_MClust()`, `ProjectCluster()` |
...
| Dimensionality reduction and clustering | `plotPCA()`, plots produced from `CreateClusterModel_SOM_MClust()` workflows |
...
| `ProjectCluster()` | New data and fitted cluster solution | `CreateClusterModel_*()` | Projected cluster assignments | Apply an existing cluster solution to future cohorts |
