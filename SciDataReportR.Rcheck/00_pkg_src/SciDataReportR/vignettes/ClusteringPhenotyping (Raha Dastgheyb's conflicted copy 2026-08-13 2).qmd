...
df_SOM <- CreateClusterModel_SOM_MClust(
  ...
  ClusterVariableName = "SOMCluster", stability_resamples = 2,
  Relabel = FALSE, min_nodes_per_cluster = NULL
)
...
PrintPlots(df_SOM$ModelInfo_SOM$ProjectionReference$plots)
...
df_TruthAgreement <- dplyr::tibble(
  ...
  TrainingARI = c(
    ...
    CalculateTruthARI(df_Training$TruthCluster, df_SOM$DataWithClusters$SOMCluster)),
  ProjectionARI = c(
