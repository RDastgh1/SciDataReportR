...
#' by [CreateSOMMclustClusterModel()]:
#'
#' \itemize{
...
#' PlotClusterMap(model$df_with_clusters, "Var1", "Var2", "Cluster")
#' }
#' @export
...
#'   df_Training, paste0("Var", 1:12), method = "finalize", final_k = 4
#' )
#' PlotClusterProfiles(model$df_with_clusters, "Cluster", paste0("Var", 1:12))
#' }
#' @export
