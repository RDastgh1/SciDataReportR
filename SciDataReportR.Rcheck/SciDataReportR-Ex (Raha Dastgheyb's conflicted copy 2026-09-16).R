...
### Title: Derive Freesurfer bilateral measures and optional ICV-adjusted
###   ratios
...
##D 
##D thickness_derived <- DeriveFreesurferVolumes(
##D   df_Thickness,
##D   derive_icv_ratios = FALSE,
##D   bilateral_method = "mean"
##D )
##D 
...
cleanEx()
nameEx("DiagnosticLikelihoodRatioTable")
### * DiagnosticLikelihoodRatioTable

flush(stderr()); flush(stdout())

### Name: DiagnosticLikelihoodRatioTable
### Title: Calculate diagnostic likelihood ratios
### Aliases: DiagnosticLikelihoodRatioTable
...
cleanEx()
nameEx("EvaluateBiomarkerPerformance")
### * EvaluateBiomarkerPerformance

flush(stderr()); flush(stdout())

### Name: EvaluateBiomarkerPerformance
### Title: Evaluate biomarker performance
### Aliases: EvaluateBiomarkerPerformance

### ** Examples

## Not run: EvaluateBiomarkerPerformance(df, "DiseaseCohort", "NfL", c("Age", "Sex"))
...
cleanEx()
nameEx("PlotBetaProfile")
### * PlotBetaProfile

flush(stderr()); flush(stdout())

### Name: PlotBetaProfile
### Title: Plot standardized beta profiles across continuous predictors
### Aliases: PlotBetaProfile
...
cleanEx()
nameEx("PlotCorrelationComparisons")
### * PlotCorrelationComparisons

flush(stderr()); flush(stdout())

### Name: PlotCorrelationComparisons
### Title: Compare correlations between two independent groups
### Aliases: PlotCorrelationComparisons
...
cleanEx()
nameEx("PlotDiagnosticLRForest")
### * PlotDiagnosticLRForest

flush(stderr()); flush(stdout())

### Name: PlotDiagnosticLRForest
### Title: Plot diagnostic likelihood ratios as a forest plot
### Aliases: PlotDiagnosticLRForest
...
cleanEx()
nameEx("PlotDiagnosticLRHeatmap")
### * PlotDiagnosticLRHeatmap

flush(stderr()); flush(stdout())

### Name: PlotDiagnosticLRHeatmap
### Title: Plot a diagnostic likelihood-ratio heatmap
### Aliases: PlotDiagnosticLRHeatmap
...
cleanEx()
nameEx("ScreenBiomarkerPerformance")
### * ScreenBiomarkerPerformance

flush(stderr()); flush(stdout())

### Name: ScreenBiomarkerPerformance
### Title: Screen biomarker performance across outcomes
### Aliases: ScreenBiomarkerPerformance

### ** Examples

## Not run: 
##D screen <- ScreenBiomarkerPerformance(
##D   data = df,
##D   outcome_vars = c("DiseaseCohort", "Progression"),
##D   biomarker_vars = c("NfL", "GFAP", "Acrocyanosis"),
##D   covariates = c("Age", "Sex")
##D )
##D 
##D screen$PerformanceTable
##D screen$Plots$Heatmap
##D screen$Plots$Heatmap %>% add_biomarker_values()
## End(Not run)
...
cleanEx()
nameEx("add_biomarker_values")
### * add_biomarker_values

flush(stderr()); flush(stdout())

### Name: add_biomarker_values
### Title: Add values to a biomarker performance heatmap
### Aliases: add_biomarker_values
...
cleanEx()
nameEx("add_delta_r_and_stars")
### * add_delta_r_and_stars

flush(stderr()); flush(stdout())

### Name: add_delta_r_and_stars
### Title: Add DeltaR values and significance stars to a correlation
###   comparison heatmap
### Aliases: add_delta_r_and_stars
