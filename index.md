...
| Clustering and cohort projection | [`CreateClusterModel_SOM_MClust()`](https://rdastgh1.github.io/SciDataReportR/reference/CreateClusterModel_SOM_MClust.md), [`ProjectCluster()`](https://rdastgh1.github.io/SciDataReportR/reference/ProjectCluster.md) |
...
| Dimensionality reduction and clustering | [`plotPCA()`](https://rdastgh1.github.io/SciDataReportR/reference/plotPCA.md), plots produced from [`CreateClusterModel_SOM_MClust()`](https://rdastgh1.github.io/SciDataReportR/reference/CreateClusterModel_SOM_MClust.md) workflows |
...
| [`ProjectCluster()`](https://rdastgh1.github.io/SciDataReportR/reference/ProjectCluster.md) | New data and fitted cluster solution | `CreateClusterModel_*()` | Projected cluster assignments | Apply an existing cluster solution to future cohorts |
...
df_Revalued <- RevalueData(
  SampleData,
  SampleVariableTypes
)$RevaluedData
df_DataDictionary <- MakeDataDictionary(SampleData)
