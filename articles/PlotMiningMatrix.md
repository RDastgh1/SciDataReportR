...
```
    ...
    # A tibble: 6 × 11
      ...
      <chr>     <chr>        <dbl>      <dbl> <chr>        <dbl> <fct> <fct>  <fct>
...
```
    ...
    [13] tibble_3.3.1           pkgconfig_2.0.3        data.table_1.18.6.1
    [16] RColorBrewer_1.1-3     correlation_0.8.8      S7_0.2.2
    [19] RcppParallel_6.2.1     lifecycle_1.0.5        compiler_4.6.1
    ...
    [31] statsExpressions_2.1.1 abind_1.4-8            tidyselect_1.2.1
    [34] sjlabelled_1.2.0       digest_0.6.39          mvtnorm_1.4-2
    [37] gtsummary_2.6.1        purrr_1.2.2            rematch2_2.1.2
    [40] labeling_0.4.3         forcats_1.0.1          ggstatsplot_1.1.1
    [43] labelled_2.16.1        fastmap_1.2.0          grid_4.6.1
    [46] cli_3.6.6              magrittr_2.0.5         patchwork_1.3.2
    [49] utf8_1.2.6             dichromat_2.0-1        broom_1.0.13
    [52] withr_3.0.3            scales_1.4.0           backports_1.5.1
    [55] estimability_2.0.0     rmarkdown_2.32         httr_1.4.9
    [58] emmeans_2.0.4          otel_0.2.0             hms_1.1.4
    [61] coda_0.19-4.1          evaluate_1.0.5         knitr_1.52
    [64] haven_2.5.5            parameters_0.29.3      viridisLite_0.4.3
    [67] rstantools_2.7.1       rlang_1.3.0            xtable_1.8-8
    [70] glue_1.8.1             jsonlite_2.0.0         R6_2.6.1              
