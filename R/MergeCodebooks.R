...
#' page shows a static screenshot rather than a live example. The screenshot is
#' regenerated by `data-raw/CodebookMergeApp-screenshot.R` (which drives the app
#' with \pkg{shinytest2} and writes to `man/figures/CodebookMergeApp.png`).
#'
#' \if{html}{\figure{CodebookMergeApp.png}{options: width="800" alt="Screenshot of the CodebookMergeApp harmonization dashboard"}}
#'
#' @examples
#' \dontrun{
