...
#' plotting function.
#'
#' @param res The list returned by [PlotCorrelationsHeatmap()]. The object
#'   should contain `Unadjusted$plot` and/or `FDRCorrected$plot` ggplot objects
#'   with plot data columns such as `R`, `P`, `P_adj`, `stars`, or `stars_FDR`.
